...
#define WDG_INT_CLEAR_MASK                  (0x04)
#define WDG_INT_CLEAR_SHIFT                 (2)
#define WDG_FEED_DOG_MASK                   (0x02)
#define WDG_FEED_DOG_SHIFT                  (1)
#define WDG_VLD_MASK                        (0x01)
#define WDG_VLD_SHIFT                       (0)

#if 0//FEED_DOG and int clear move to WATCHDOG_COMP_VLD_REG BIT[2:1]
